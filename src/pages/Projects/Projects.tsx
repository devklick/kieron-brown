      ...
      <div className="projects__card-container">
        ...
        <ProjectCard
          ...
          description={[
            ...
            it up to date with the latest technologies and adding new features.`,
            ...
            this game to see how I can make improvements to the code base, tody 
            things up, add features, or even just play the game!`,
        ...
        <ProjectCard
          ...
          description={[
            ...
            set up to run the code base. In many cases these are defined in the 
            repository readme, but the readme often goes stale and gets forgotten 
            about. In other cases, it's often a case of having to search through 
        ...
        <ProjectCard
          ...
          description={[
            ...
            `TermBlock is a React library that mimics a terminal, purely from a 
            display point of view. It allows you to display a terminal on your 
